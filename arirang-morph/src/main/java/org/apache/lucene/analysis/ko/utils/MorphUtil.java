...
public class MorphUtil {
  ...
  public static String buildTypeString(String word, char type) {
   ...
   /** (추가)
    * 어간의 세부 종류값을 포함한 형태소 유형 출력을 위한 문자열을 생성한다.
    * @param word  word to be printed
    * @param type  the type of the input word
    * @param speType  the specific type of the input word
    */
  public static String buildTypeString(String word, char type, char speType) {
	  StringBuffer sb = new StringBuffer();
	  sb.append(word);
	  sb.append("(");
	  sb.append(type);
